...
@property (atomic) osal::Kernel* m_kernel;
@end

// ----------------------------------------------------------------------------
@implementation OSALView
// ----------------------------------------------------------------------------
...
static CVReturn MyDisplayLinkCallback(CVDisplayLinkRef displayLink,
    ...
    return [(__bridge OSALView*)displayLinkContext getFrameForTime:outputTime];
}
// ----------------------------------------------------------------------------
...
- (void)mouseMoved:(NSEvent *)theEvent {
    ...
    osal::TouchEvent ev;
    ev.type = osal::TouchEvent::TouchMove;
    ev.pointer_id = 0;
    ev.x = pos.x;
...
- (void)mouseDown:(NSEvent *)theEvent {
    ...
    NSRect r = [self bounds];
    osal::TouchEvent ev;
    ev.type = osal::TouchEvent::TouchDown;
    ev.pointer_id = 0;
    ev.x = pos.x;
    ev.y = (int)(r.size.height - pos.y);
    ev.button = 1;
...
- (void)mouseUp:(NSEvent *)theEvent {
    ...
    NSRect r = [self bounds];
    osal::TouchEvent ev;
    ev.type = osal::TouchEvent::TouchUp;
    ev.pointer_id = 0;
    ev.x = pos.x;
    ev.y = (int)(r.size.height - pos.y);
    ev.button = 1;
...
- (void)scrollWheel:(NSEvent *)theEvent {
    ...
    NSRect r = [self bounds];
    osal::TouchEvent ev;
    ev.type = osal::TouchEvent::Scroll;
    ev.pointer_id = 0;
    ev.x = pos.x;
    ev.y = (int)(r.size.height - pos.y);
