...
fail:
    ...
    jobject jcfg = jni.CallStaticObjectMethod("android/graphics/Bitmap$Config",
                                              "valueOf", "(Ljava/lang/String;)Landroid/graphics/Bitmap$Config;",
                                              jni.NewStringUTF("ARGB_8888"));
    // jbitmap = Bitmap.createBitmap(width, height, jcfg);
    jobject   jbitmap = jni.CallStaticObjectMethod("android/graphics/Bitmap",
                                                   "createBitmap", "(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;",
                                                   width, height, jcfg);
    // jcanvas = new Canvas(jbitmap);
    jobject   jcanvas = jni.NewObject("android/graphics/Canvas", "(Landroid/graphics/Bitmap;)V", jbitmap);
    // jpaint = new Paint(ANTI_ALIAS_FLAG);
    const jint ANTI_ALIAS_FLAG = 1;
    jobject   jpaint = jni.NewObject("android/graphics/Paint", "(I)V", ANTI_ALIAS_FLAG);
    // jrect = new Rect();
    jobject   jrect = jni.NewObject("android/graphics/Rect", "()V");

    // Retain our objects
    m_jni.bitmap = jni.NewGlobalRef(jbitmap);
    m_jni.canvas = jni.NewGlobalRef(jcanvas);
    m_jni.paint = jni.NewGlobalRef(jpaint);
    m_jni.rect = jni.NewGlobalRef(jrect);

    // Cache Method
    m_jni.bitmap_class = (jclass)jni.NewGlobalRef(jni.FindClass("android/graphics/Bitmap"));
    m_jni.bitmap_eraseColor = jni.GetMethodID(m_jni.bitmap_class, "eraseColor", "(I)V");
    m_jni.canvas_class = (jclass)jni.NewGlobalRef(jni.FindClass("android/graphics/Canvas"));
    m_jni.canvas_drawText = jni.GetMethodID(m_jni.canvas_class, "drawText", "(Ljava/lang/String;FFLandroid/graphics/Paint;)V");
    m_jni.canvas_drawRect = jni.GetMethodID(m_jni.canvas_class, "drawRect", "(FFFFLandroid/graphics/Paint;)V");
    m_jni.canvas_drawLine = jni.GetMethodID(m_jni.canvas_class, "drawLine", "(FFFFLandroid/graphics/Paint;)V");
    m_jni.paint_class = (jclass)jni.NewGlobalRef(jni.FindClass("android/graphics/Paint"));
    m_jni.paint_setTextSize = jni.GetMethodID(m_jni.paint_class, "setTextSize", "(F)V");
    m_jni.paint_setARGB = jni.GetMethodID(m_jni.paint_class, "setARGB", "(IIII)V");
    m_jni.paint_getTextBounds = jni.GetMethodID(m_jni.paint_class, "getTextBounds", "(Ljava/lang/String;IILandroid/graphics/Rect;)V");
    m_jni.rect_class = (jclass)jni.NewGlobalRef(jni.FindClass("android/graphics/Rect"));
    m_jni.rect_height = jni.GetMethodID(m_jni.rect_class, "height", "()I");
    m_jni.rect_width = jni.GetMethodID(m_jni.rect_class, "width", "()I");
    m_jni.glut_class = (jclass)jni.NewGlobalRef(jni.FindClass("android/opengl/GLUtils"));
    m_jni.glut_texImage2D = jni.GetStaticMethodID(m_jni.glut_class, "texImage2D", "(IILandroid/graphics/Bitmap;I)V");

    // Reset Paint color
    jni.CallVoidMethod(m_jni.paint, m_jni.paint_setARGB, 0, 0, 0, 0);
    return false;
fail:
    release();
    return false;
...
void DrawableCanvas::release() {
    ...
    if (m_jni.bitmap_class) {
        jni.DeleteGlobalRef(m_jni.bitmap_class);
        m_jni.bitmap_class = nullptr;
    }
    if (m_jni.canvas_class) {
        jni.DeleteGlobalRef(m_jni.canvas_class);
        m_jni.canvas_class = nullptr;
    }
    if (m_jni.rect_class) {
        jni.DeleteGlobalRef(m_jni.rect_class);
        m_jni.rect_class = nullptr;
    }
    if (m_jni.glut_class) {
        jni.DeleteGlobalRef(m_jni.glut_class);
        m_jni.glut_class = nullptr;
    }
    if (m_jni.bitmap) {
        jni.DeleteGlobalRef(m_jni.bitmap);
        m_jni.bitmap = nullptr;
    }
    if (m_jni.canvas) {
        jni.DeleteGlobalRef(m_jni.canvas);
        m_jni.canvas = nullptr;
    }
    if (m_jni.paint) {
        jni.DeleteGlobalRef(m_jni.paint);
        m_jni.paint = nullptr;
    }
    if (m_jni.rect) {
        jni.DeleteGlobalRef(m_jni.rect);
        m_jni.rect = nullptr;
    }
#else
    #error Not Implemented!
...
void DrawableCanvas::calctext(const char* utf8, int* w, int* h) {
    ...
    *h = rc.bottom - rc.top + 2;
    ...
    jsize slen = jni.GetStringLength(s);
    jni.CallVoidMethod(m_jni.paint, m_jni.paint_getTextBounds, s, 0, slen, m_jni.rect);
